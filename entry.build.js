...
/***/ function(module, exports, __webpack_require__) {
  ...
  _react2['default'].render(_react2['default'].createElement(_app.App, null), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _rebound = __webpack_require__(160);
  ...
  var Slideshow = _react2['default'].createClass({
      ...
      return _react2['default'].createElement(
        ...
        { style: styles.slideshow.wrap,
          ...
          onMouseLeave: function () {
            return _this.setState({ opacity: 0 });
          } },
        ...
        _react2['default'].createElement(
          _src.Springs,
          { to: _extends({}, this.convert(this.state.x, this.state.y), { opacity: this.state.opacity }), tension: 50, friction: 8 },
          function (val) {
            return _react2['default'].createElement(
              'div',
              { style: _extends({}, val, { width: _this.props.n * 60 }, styles.slideshow.bar), onMouseLeave: function () {
                  return _this.setState({ hover: -1 });
                } },
              times(_this.props.n, function (i) {
                return _react2['default'].createElement(
                  _src.Spring,
                  { to: _this.state.hover === i ? 1 : 0, overShootClamping: true },
                  function (bg) {
                    return _react2['default'].createElement(
                      'div',
                      { key: i, style: _extends({}, styles.slideshow.thumb, { backgroundColor: _rebound2['default'].util.interpolateColor(bg, '#ccc', '#fff') }),
                        onMouseEnter: function () {
                          return _this.setState({ hover: i });
                        },
                        onClick: function () {
                          return _this.setState({ active: i, selected: Math.random() / 100 });
                        } },
                      i
                    );
                  }
    ...
    statics: {
      convert: function convert(W, w, H, h, x, y) {
        return {
  ...
  var Followers = _react2['default'].createClass({
    ...
    render: function render() {
      ...
      return _react2['default'].createElement(
        'div',
        { onMouseMove: this.onMouseMove, style: styles.followers.wrap },
        _react2['default'].createElement(
          _src.Springs,
          { to: { x: this.state.x, y: this.state.y }, tension: 10, friction: 1 },
          function (vals) {
            return _react2['default'].createElement('div', { style: _extends({ left: vals.x - 10, top: vals.y - 10 }, styles.followers.box, styles.followers.red) });
          }
        ),
        _react2['default'].createElement(
          _src.Spring,
          { to: this.state.x, tension: 15, friction: 1.5 },
          function (x) {
            return _react2['default'].createElement(
              _src.Spring,
              { to: _this2.state.y, tension: 34, friction: 7 },
              function (y) {
                return _react2['default'].createElement('div', { style: _extends({ left: x - 10, top: y - 10 }, styles.followers.box, styles.followers.blue) });
              }
            );
          }
        )
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var React;
  try {
    React = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"react-native\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
  } catch (e) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=entry.build.js.map